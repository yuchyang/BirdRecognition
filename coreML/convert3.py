...
#     sys.exit(0)
# net_type = sys.argv[1]
model_path = 'D://BirdRecognition//mobilenetv2-Epoch-106-Loss-6.8959480877761.pth'
...
net = create_mobilenetv2_ssd_lite(200, is_test=True)
...
model_path = "D://BirdRecognition//SSD//model2.onnx"
